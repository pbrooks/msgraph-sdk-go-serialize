# https://github.com/thomaspoignant
GOCMD=go
GOTEST=$(GOCMD) test
GOVET=$(GOCMD) vet
BINARY_NAME=azure-extension-example
VERSION?=0.0.1
SERVICE_PORT?=3000
DOCKER_REGISTRY?=false #if set it should finished by /
...
build: ## Build your project and put the output binary in out/bin/
	mkdir -p out/bin
	GO111MODULE=on $(GOCMD) build -mod auth -mod vendor -o out/bin/$(BINARY_NAME) .
