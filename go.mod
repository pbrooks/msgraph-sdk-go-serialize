module github.com/pbrooks/msgraph-sdk-go-serialize
...
require (
	...
	github.com/microsoft/kiota/authentication/go/azure v0.0.0-20220107192817-ce9fb06a3e34
	github.com/microsoftgraph/msgraph-sdk-go v0.4.0
